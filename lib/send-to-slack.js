...
var slack = {
    ...
    formmatingMessage :  function(data, callback) {
        ...
        "\nGerado " + moment().format('LLLL') +
        "\nInstagram:\n" +
        "\u0020\u0020Total de postagens: " + data.instagram.postagens_total + "\n" +
        "\u0020\u0020Total de seguidores: " + data.instagram.seguidores + "\n" +
        "Twitter:\n\u0020\u0020Total de postagens: " + data.twitter.postagens_total + "\n" +
        "\u0020\u0020Postagens Favoritas: " + data.twitter.postagens_favoritas + "\n" +
        "\u0020\u0020Total de Seguidores: " + data.twitter.seguidores + "\n" +
